...
const EventAdminPage = () => {
  ...
  return (
    ...
    <div style={{ flex: '1', padding: '20px' }}>
      ...
      {showForm && (
        <div>
          <h2 style={{ fontSize: '24px', color: 'black', textAlign: 'center', fontFamily: 'Arial, sans-serif' }}>Add Event</h2>
      ...
      <div style={{ marginTop: '40px',width :"40%",display:"flex",columnGap:"20px"}}>
        <h2 style={{ fontSize: '24px', color: 'black', textAlign: 'center', fontFamily: 'Arial, sans-serif',display:"block" }}>Existing Events</h2>
